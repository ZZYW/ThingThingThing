...
Shader "ThingThingThing/Main" {
    Properties {
        ...
        _VertexOffsetPara01 ("VertexOffsetPara01", Range(1, 500)) = 1
        _VertexOffsetTimeMulti ("VertexOffsetTimeMulti", Range(0, 1)) = 0
        _VertexOffsetSmoothFactor ("VertexOffsetSmoothFactor", Range(0, 1)) = 0
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            uniform float _VertexOffsetPara01;
            uniform float _VertexOffsetTimeMulti;
            uniform float _VertexOffsetSmoothFactor;
            struct VertexInput {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_7614 = _Time;
                float2 node_6066 = (((o.uv0*_VertexOffsetPara01)+(node_7614.g*_VertexOffsetTimeMulti))/_VertexOffsetSmoothFactor);
                float2 node_1762_skew = node_6066 + 0.2127+node_6066.x*0.3713*node_6066.y;
