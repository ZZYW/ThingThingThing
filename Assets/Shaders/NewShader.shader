...
Shader "Shader Forge/NewShader" {
    Properties {
        ...
        _Gloss ("Gloss", Range(0, 1)) = 0.6495731
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
